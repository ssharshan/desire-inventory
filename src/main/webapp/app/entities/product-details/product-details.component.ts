...
export class ProductDetailsComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.productDetailsService
        ...
        .subscribe(
          (res: HttpResponse<IProductDetails[]>) => this.paginateProductDetails(res.body, res.headers),
  ...
  protected paginateProductDetails(data: IProductDetails[], headers: HttpHeaders) {
