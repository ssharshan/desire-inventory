...
import com.di.inventory.config.audit.AuditEventConverter;
import com.di.inventory.domain.PersistentAuditEvent;
...
import static com.di.inventory.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
