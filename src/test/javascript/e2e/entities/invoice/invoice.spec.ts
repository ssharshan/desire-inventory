...
describe('Invoice e2e test', () => {
  ...
  it('should load Invoices', async () => {
    ...
    expect(await invoiceComponentsPage.getTitle()).to.eq('diInventoryApp.invoice.home.title');
  });
  ...
  it('should load create Invoice page', async () => {
    ...
    expect(await invoiceUpdatePage.getPageTitle()).to.eq('diInventoryApp.invoice.home.createOrEditLabel');
  ...
  it('should create and save Invoices', async () => {
    ...
    await promise.all([
      ...
      invoiceUpdatePage.setDiscountInput('5'),
    ...
    expect(await invoiceUpdatePage.getAmountInput()).to.eq('5', 'Expected amount value to be equals to 5');
    expect(await invoiceUpdatePage.getDiscountInput()).to.eq('5', 'Expected discount value to be equals to 5');
  ...
  it('should delete last Invoice', async () => {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle()).to.eq('diInventoryApp.invoice.delete.question');
